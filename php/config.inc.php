...
$config['smtp_user'] 			= 'ceitechsender@gmail.com'; 						// you@gmail.com
$config['smtp_pass'] 			= 'Sender2015?';						// password
$config['smtp_ssl']				= false;					// should remain false

// Who receive all emails?
$config['send_to']				= 'info@ceitechs.com';	// destination of all emails sent throught contact form

// Email Subject
$config['subject']				= 'CEITECHS Contact Form';	// subject of emails you receive
...
define('UPLOAD_FOLDER_URL',	'http://www.ceitechs.com/php/_upload/');	// Full url path to upload folder (used for contact files) - slash at the end!
